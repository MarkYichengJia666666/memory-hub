...
@Service
public class FinishSupplementSelector extends AbstractInReviewStatusSelector {
  ...
  public List<HomepageUserInfoProcessorType> getUserInfoProcessorList() {
    return Lists.newArrayList(HomepageUserInfoProcessorType.LOGIN_USER_INFO_PROCESSOR, HomepageUserInfoProcessorType.FINISH_SUPPLEMENT_USER_INFO);
  }

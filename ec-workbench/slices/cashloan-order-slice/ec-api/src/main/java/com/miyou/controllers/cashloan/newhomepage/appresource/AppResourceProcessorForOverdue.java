...
@Service
@Slf4j
public class AppResourceProcessorForOverdue extends BannerHomePopupProcessor{
  ...
  public AppResourceProcessorType getProcessorType() {
    return AppResourceProcessorType.BANNER_HOME_POP_UP_FOR_OVERDUE;
  }
  ...
  public void process(HomeAppResourceResponse fieldsInfo, HomePageContext homePageContext) {
    if (homePageContext.getHomePageType() == HomePageType.HOME_PAGE_FOR_LEVEL_1
        && jumpBillPageTool.canJumpBillPageForOverdue(homePageContext.getUserId())
    ) {

...
- 下一步：确认后执行 `python3 propose_diff.py --report capillary-20260908-184847.md --vessel-id hp-817-first --dry-run`
...
- 下一步：确认后执行 `python3 propose_diff.py --report capillary-20260908-184847.md --vessel-id hp-817-reloan --dry-run`
...
- 下一步：确认后执行 `python3 propose_diff.py --report capillary-20260908-184847.md --vessel-id coupon-v1 --dry-run`
...
- 下一步：确认后执行 `python3 propose_diff.py --report capillary-20260908-184847.md --vessel-id coupon-v1-reopen-v3 --dry-run`

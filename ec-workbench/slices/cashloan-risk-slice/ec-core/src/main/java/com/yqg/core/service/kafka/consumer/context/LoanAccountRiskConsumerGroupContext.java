...
import com.yqg.core.service.kafka.consumer.processor.LoanAccountRiskProcessor;
...
@Service
public class LoanAccountRiskConsumerGroupContext implements IConsumerGroupContext {
  @Autowired
  ...
  public Properties getConsumerProperties() {
    ...
    props.put(ConsumerConfig.GROUP_ID_CONFIG, ConsumerGroup.CASH_LOAN_EVENT_LOAN_ACCOUNT_RISK.name());
  ...
  public Class<? extends IKafkaMessageProcessor> getProcessorClass() {
    return LoanAccountRiskProcessor.class;
  }

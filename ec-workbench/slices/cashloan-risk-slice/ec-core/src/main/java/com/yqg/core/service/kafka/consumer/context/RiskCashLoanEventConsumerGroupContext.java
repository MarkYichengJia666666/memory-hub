...
import com.yqg.core.service.kafka.consumer.processor.RiskCashLoanEventProcessor;
...
@Service
public class RiskCashLoanEventConsumerGroupContext implements IConsumerGroupContext {
  ...
  public Properties getConsumerProperties() {
    ...
    props.put(ConsumerConfig.GROUP_ID_CONFIG, ConsumerGroup.EC_RISK_CASH_LOAN_EVENT.name());
  ...
  public Class<? extends IKafkaMessageProcessor> getProcessorClass() {
    return RiskCashLoanEventProcessor.class;
  }

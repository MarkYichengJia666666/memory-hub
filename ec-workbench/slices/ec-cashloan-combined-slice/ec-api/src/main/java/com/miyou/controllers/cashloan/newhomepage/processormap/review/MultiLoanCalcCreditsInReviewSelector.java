...
import static com.miyou.controllers.cashloan.newhomepage.enums.PageCardV3ProcessorType.*;

@Service
public class MultiLoanCalcCreditsInReviewSelector implements IUserInfoProcessorSelector, IMiddleProcessorSelector, ICommonProcessorSelector, IAlertProcessorSelector {

  @Override
  public IDNHomepageLoanStatusV5 getStatus() {
    return IDNHomepageLoanStatusV5.MULTI_LOAN_CALC_CREDITS_IN_REVIEW;
  }

  @Override
  public List<HomepageUserInfoProcessorType> getUserInfoProcessorList() {
    return Lists.newArrayList(HomepageUserInfoProcessorType.LOGIN_USER_INFO_PROCESSOR, HomepageUserInfoProcessorType.CALC_CREDITS_IN_REVIEW_USER_INFO);
  }
  ...
  public List<PageCardV3ProcessorType> getPageCardSelector() {
    return Lists.newArrayList(COMMON_TYPE, REVIEW_FOR_RISK, REPAYMENT_CARD, PageCardV3ProcessorType.LAST_COMMON_CARD);
  }

  ...
  public abstract class AbstractWaitingForSupplementSelector implements IUserInfoProcessorSelector, IMiddleProcessorSelector , ICommonProcessorSelector {
    @Override
    public List<HomepagePointProcessorType> getPointProcessorList() {
      ...
      res.add(HomepagePointProcessorType.WAITING_FOR_SUPPLEMENT_POINT);
      return res;
    }

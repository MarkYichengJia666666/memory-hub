...
@Service
public class RiskControlAcceptedSubStepProcessor extends BaseOrderSubStepProcessor {
  @Autowired
  ...
  public boolean checkCondition(CashLoanOrderVO orderVO, List<OrderSubStepVO> orderSubStepVOs) {
    ...
    return loanUserRiskTraceVO != null && loanUserRiskTraceVO.creditsStatus == LoanCreditsStatus.ACCEPTED;
  }

  @Override
  public OrderSubStep getOrderSubStep() {
    return OrderSubStep.RISK_CONTROL_ACCEPTED;
  }

...
@Service
public class MultiLoanDebtCheckSelector extends AbstractDebtOrderCheckProcessor implements IAlertProcessorSelector {
  @Override
  public IDNHomepageLoanStatusV5 getStatus() {
    return IDNHomepageLoanStatusV5.MULTI_LOAN_DEBT_CHECK;
  }

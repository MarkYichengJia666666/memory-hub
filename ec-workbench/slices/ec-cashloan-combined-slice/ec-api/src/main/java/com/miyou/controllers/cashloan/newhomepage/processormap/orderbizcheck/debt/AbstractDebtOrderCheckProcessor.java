...
public abstract class AbstractDebtOrderCheckProcessor implements IUserInfoProcessorSelector, ICommonProcessorSelector {
  @Override
  public List<HomepageUserInfoProcessorType> getUserInfoProcessorList() {
    return Lists.newArrayList(HomepageUserInfoProcessorType.LOGIN_USER_INFO_PROCESSOR, HomepageUserInfoProcessorType.DEBT_BIZ_CHECK);
  }
  ...
  public List<HomepageUserInfoV3ProcessorType> getPageUserInfoV3Type() {
    return Lists.newArrayList(HomepageUserInfoV3ProcessorType.DEBT_BIZ_CHECK_V3, HomepageUserInfoV3ProcessorType.REPAYMENT_INFO_V3);
  }
}

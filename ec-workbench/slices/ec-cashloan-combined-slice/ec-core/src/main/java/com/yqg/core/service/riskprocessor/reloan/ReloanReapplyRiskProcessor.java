 ...
 * @author Zoran Zhang
 * @Description:
 * @date 2021/8/25 11:30 上午
 */
@Service
public class ReloanReapplyRiskProcessor extends BaseReloanApplyCalcCreditsRiskProcessor {
  @Autowired
  ...
  protected void assertBeforeSubmit(LoanUserCreditsInfoRecord creditsInfoRecord, RiskProcessParam param) {
    checkReloanReapplyCredits(creditsInfoRecord, ImmutableList.of(getLoanUserRiskType()), param.extraInfo.submitRisk);
  }

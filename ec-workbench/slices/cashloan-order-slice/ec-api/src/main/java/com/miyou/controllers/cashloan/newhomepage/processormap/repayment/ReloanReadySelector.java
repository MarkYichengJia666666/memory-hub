...
@Service
public class ReloanReadySelector implements IUserInfoProcessorSelector, IMiddleProcessorSelector, ICommonProcessorSelector, IAlertProcessorSelector {
  @Override
  ...
  public List<HomepageUserInfoProcessorType> getUserInfoProcessorList() {
    return Lists.newArrayList(HomepageUserInfoProcessorType.LOGIN_USER_INFO_PROCESSOR,
        HomepageUserInfoProcessorType.REPAYMENT_USER_INFO, HomepageUserInfoProcessorType.RELOAN_REJECT_USER_INFO,
        HomepageUserInfoProcessorType.READY_USER_INFO, HomepageUserInfoProcessorType.REPAYMENT_QUOTA_CARD_INFO);
  }
  ...
  public List<HomepageUserInfoV3ProcessorType> getPageUserInfoV3Type() {
    return Lists.newArrayList(HomepageUserInfoV3ProcessorType.HOME_PAGE_GUIDE_BUBBLE_V3,
        HomepageUserInfoV3ProcessorType.REPAYMENT_INFO_V3, HomepageUserInfoV3ProcessorType.AUTO_JUMP_BILL_PAGE_FOR_NOT_OVERDUE);
  }
